        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <ul>
                    ...
                    <li><a href="#prefer-dedupe"><code>prefer-dedupe</code></a></li>
                    ...
                    <li><a href="#cpu"><code>cpu</code></a></li>
...
aliases: add, i, in, ins, inst, insta, instal, isnt, isnta, isntal, isntall
        ...
        <ul>
            ...
            <li>
                ...
                <p>If <code>&lt;folder&gt;</code> sits inside the root of your project, its dependencies will be
                    installed and may
                ...
                <blockquote>
                    <p>NOTE: If you want to install the content of a directory like a package from the registry instead
                        of creating a link, you would need to use the <code>--install-links</code> option.</p>
                </blockquote>
                <p>Example:</p>
...
npm install ./sub-package
            ...
            <li>
                ...
                <p>Do a <code>&lt;name&gt;@&lt;tag&gt;</code> install, where <code>&lt;tag&gt;</code> is the "tag"
                    config. (See
                    <a href="../using-npm/config#tag.html"><code>config</code></a>. The config's default value is <code>latest</code>.)
                </p>
