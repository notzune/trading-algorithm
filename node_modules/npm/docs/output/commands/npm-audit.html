...
<section id="content">
    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#package-lock">Package lock</a></li>
                ...
                <ul>
                    ...
                    <li><a href="#package-lock2"><code>package-lock</code></a></li>
    ...
    <div id="_content"><h3 id="synopsis">Synopsis</h3>
        ...
        <p>The npm CLI supports registry signatures and signing keys provided by any registry if the following
            conventions are followed:</p>
        <ol>
            <li>Signatures are provided in the package's <code>packument</code> in each published version within the
  ...
  "signatures": [{
    ...
    "sig": "a312b9c3cb4a1b693e8ebac5ee1ca9cc01f2661c14391917dcb111517f72370809..."
        ...
        <p>See this <a href="https://registry.npmjs.org/light-cycle/1.4.3">example</a> of a signed package from the
            public npm registry.</p>
        ...
        <ol start="2">
            <li>Public signing keys are provided at <code>registry-host.tld/-/npm/v1/keys</code> in the following
                format:
            </li>
        </ol>
        <pre><code>{
  "keys": [{
    ...
    "key": "{{B64_PUBLIC_KEY}}"
        ...
        <p>Keys response:</p>
        <ul>
            <li><code>expires</code>: null or a simplified extended <a href="https://en.wikipedia.org/wiki/ISO_8601%22">ISO
                8601 format</a>: <code>YYYY-MM-DDTHH:mm:ss.sssZ</code></li>
        ...
        <p>See this <a href="https://registry.npmjs.org/-/npm/v1/keys%22">example key's response from the public npm
            registry</a>.</p>
