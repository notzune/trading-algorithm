...
<section id="content">
  ...
  "license" : "BSD-3-Clause"
        ...
        <p>If your package is licensed under multiple common licenses, use an <a
                href="https://spdx.dev/specifications/">SPDX
    ...
    "http://example.com/donateAlso",
    {
      ...
      "url" : "https://www.patreon.com/my-account"
        ...
        <p>To use this, supply a <code>bin</code> field in your package.json which is a map of
            ...
            file in the <code>bin</code> field, so it is available to run by <code>name</code> or <code>name.cmd</code>
            (on
  ...
  "bundleDependencies": [
    ...
    "super-streams"
        ...
        <p>If a dependency can be used, but you would like npm to proceed if it cannot
            ...
            failures do not cause installation to fail. Running <code>npm install --omit=optional</code> will prevent
    ...
    "baz": {
      "bar": {
        ...
        <p>The key of an override can also include a version, or range of versions.
            To override <code>foo</code> to <code>1.0.0</code>, but only when it's a child of <code>bar@2.0.0</code>:
        </p>
        <pre><code class="language-json">{
  "overrides": {
    "bar@2.0.0": {
