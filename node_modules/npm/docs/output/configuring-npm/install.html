    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <ul>
            ...
            <li><a href="#using-a-node-version-manager-to-install-nodejs-and-npm">Using a Node version manager to
                install Node.js and
                npm</a></li>
            <li><a href="#using-a-node-installer-to-install-nodejs-and-npm">Using a Node installer to install Node.js
                and
                npm</a></li>
        </ul>
...
npm -v
        ...
        <p>Node version managers allow you to install and switch between multiple
            ...
            <a href="https://github.com/search?q=node+version+manager+archived%3Afalse&amp;type=repositories&amp;ref=advsearch">search
                for them on GitHub</a>.</p>
