    ...
    <section id="table_of_contents">
        ...
        <div id="_table_of_contents">
            <ul>
                ...
                <li><a href="#where-can-i-find-my-and-others-published-packages">Where can I find my (and others')
                    published packages?</a></li>
    ...
    <div id="_content"><h3 id="description">Description</h3>
        ...
        <p>The registry URL used is determined by the scope of the package (see
            ...
            <a href="../configuring-npm/npmrc.html"><code>npmrc</code></a>, and <a
                    href="../using-npm/config.html"><code>config</code></a> for more on
